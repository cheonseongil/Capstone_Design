...
public class Professor_ChangePasswordActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.professor_change_password);
        ...
        layoutConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Professor_ChangePasswordActivity.this, "비밀번호 변경이 시도됩니다.", Toast.LENGTH_SHORT).show();
            }
        });
