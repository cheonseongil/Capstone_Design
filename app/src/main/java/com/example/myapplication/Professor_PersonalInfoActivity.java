...
public class Professor_PersonalInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.professor_personal_info);
        ...
        buttonChangePassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Professor_PersonalInfoActivity.this, Professor_ChangePasswordActivity.class);
